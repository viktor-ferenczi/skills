...
([SDL_AppResult](SDL_AppResult)) Returns [SDL_APP_FAILURE](SDL_AppResult)
to terminate with an error, [SDL_APP_SUCCESS](SDL_AppResult) to terminate
with success, [SDL_APP_CONTINUE](SDL_AppResult) to continue.
...
returns [SDL_APP_CONTINUE](SDL_AppResult). The function should operate
...
If this function returns [SDL_APP_CONTINUE](SDL_AppResult), the app will
