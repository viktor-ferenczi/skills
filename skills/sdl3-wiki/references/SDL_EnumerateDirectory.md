...
[SDL_ENUM_SUCCESS](SDL_EnumerationResult) or
[SDL_ENUM_FAILURE](SDL_EnumerationResult).

This will return false if there was a system problem in general, or if a
callback returns [SDL_ENUM_FAILURE](SDL_EnumerationResult). A successful return
means a callback returned [SDL_ENUM_SUCCESS](SDL_EnumerationResult) to halt
