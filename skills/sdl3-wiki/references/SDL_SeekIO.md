...
| [SDL_IOWhence](SDL_IOWhence)   | **whence**  | any of [`SDL_IO_SEEK_SET`](SDL_IOWhence), [`SDL_IO_SEEK_CUR`](SDL_IOWhence), [`SDL_IO_SEEK_END`](SDL_IOWhence). |
...
- [`SDL_IO_SEEK_SET`](SDL_IOWhence): seek from the beginning of data
- [`SDL_IO_SEEK_CUR`](SDL_IOWhence): seek relative to current read point
- [`SDL_IO_SEEK_END`](SDL_IOWhence): seek relative to the end of data
