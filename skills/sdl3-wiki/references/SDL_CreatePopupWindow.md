...
| [SDL_WindowFlags](SDL_WindowFlags) | **flags**    | [SDL_WINDOW_TOOLTIP](SDL_WindowFlags) or [SDL_WINDOW_POPUP_MENU](SDL_WindowFlags), and zero or more additional [SDL_WindowFlags](SDL_WindowFlags) OR'd together. |
...
- [`SDL_WINDOW_TOOLTIP`](SDL_WindowFlags): The popup window is a tooltip
  and will not pass any input events.
- [`SDL_WINDOW_POPUP_MENU`](SDL_WindowFlags): The popup window is a
...
[`SDL_WINDOW_NOT_FOCUSABLE`](SDL_WindowFlags) flag, setting the
