...
[SDL_EVENT_MOUSE_MOTION](SDL_EventType) event, pushing a button
generates [SDL_EVENT_MOUSE_BUTTON_DOWN](SDL_EventType), etc,
...
[SDL_EVENT_MOUSE_ADDED](SDL_EventType) and
[SDL_EVENT_MOUSE_REMOVED](SDL_EventType) events as they are
