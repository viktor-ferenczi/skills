...
[SDL_ICONV_E2BIG](SDL_iconv) is returned when the output buffer is
too small, or [SDL_ICONV_EILSEQ](SDL_iconv) is returned when an
invalid input sequence is encountered, or
[SDL_ICONV_EINVAL](SDL_iconv) is returned when an incomplete input
