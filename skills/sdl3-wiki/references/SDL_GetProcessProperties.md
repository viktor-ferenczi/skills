...
- [`SDL_PROP_PROCESS_PID_NUMBER`](SDL_GetProcessProperties): the process
  ID of the process.
- [`SDL_PROP_PROCESS_STDIN_POINTER`](SDL_GetProcessProperties): an
  ...
  set to [`SDL_PROCESS_STDIO_APP`](SDL_ProcessIO).
- [`SDL_PROP_PROCESS_STDOUT_POINTER`](SDL_GetProcessProperties): a
  ...
  set to [`SDL_PROCESS_STDIO_APP`](SDL_ProcessIO).
- [`SDL_PROP_PROCESS_STDERR_POINTER`](SDL_GetProcessProperties): a
