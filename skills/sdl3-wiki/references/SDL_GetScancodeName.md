...
e.g. the name for [`SDL_SCANCODE_LGUI`](SDL_Scancode) is "Left GUI"
...
[`SDL_SCANCODE_RETURN`](SDL_Scancode) and
[`SDL_SCANCODE_RETURN2`](SDL_Scancode) (both called "Return"). This
