...
- [`SDL_MESSAGEBOX_ERROR`](SDL_MessageBoxFlags): error dialog
- [`SDL_MESSAGEBOX_WARNING`](SDL_MessageBoxFlags): warning dialog
- [`SDL_MESSAGEBOX_INFORMATION`](SDL_MessageBoxFlags): informational
  dialog
