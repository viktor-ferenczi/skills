...
([SDL_EVENT_TEXT_INPUT](SDL_EventType) and
[SDL_EVENT_TEXT_EDITING](SDL_EventType) events) in the specified
...
- [`SDL_PROP_TEXTINPUT_TYPE_NUMBER`](SDL_StartTextInputWithProperties) - an
  [SDL_TextInputType](SDL_TextInputType) value that describes text being
  input, defaults to [SDL_TEXTINPUT_TYPE_TEXT](SDL_TextInputType).
- [`SDL_PROP_TEXTINPUT_CAPITALIZATION_NUMBER`](SDL_StartTextInputWithProperties)
  ...
  [SDL_CAPITALIZE_SENTENCES](SDL_Capitalization) for normal text
  entry, [SDL_CAPITALIZE_WORDS](SDL_Capitalization) for
  [SDL_TEXTINPUT_TYPE_TEXT_NAME](SDL_TextInputType), and
  [SDL_CAPITALIZE_NONE](SDL_Capitalization) for e-mail addresses,
...
- [`SDL_PROP_TEXTINPUT_TITLE_STRING`](SDL_StartTextInputWithProperties) - a
