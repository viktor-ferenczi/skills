...
Returns [SDL_APP_FAILURE](SDL_AppResult) to terminate with an error,
[SDL_APP_SUCCESS](SDL_AppResult) to terminate with success,
[SDL_APP_CONTINUE](SDL_AppResult) to continue.
