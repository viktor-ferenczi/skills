...
- "hide_numpad": The numpad keysyms will be translated into their
  ...
  [SDLK_KP_4](SDL_Keycode) would become [SDLK_4](SDL_Keycode) if
  [SDL_KMOD_NUM](SDL_Keymod) is set in the event modifiers, and
  [SDLK_LEFT](SDL_Keycode) if it is unset.
- "french_numbers": The number row on French keyboards is inverted, so
  pressing the 1 key would yield the keycode [SDLK_1](SDL_Keycode), or '1',
  instead of [SDLK_AMPERSAND](SDL_Keycode), or '&'
- "latin_letters": For keyboards using non-Latin letters, such as Russian
  ...
  [SDL_SCANCODE_A](SDL_Scancode) on a Russian keyboard would yield 'a'
