...
- [`SDL_PROP_WINDOW_CREATE_X_NUMBER`](SDL_CreateWindowWithProperties): the
...
- [`SDL_PROP_WINDOW_CREATE_Y_NUMBER`](SDL_CreateWindowWithProperties): the
...
- [`SDL_PROP_WINDOW_CREATE_WAYLAND_CREATE_EGL_WINDOW_BOOLEAN`](SDL_CreateWindowWithProperties)
  ...
  the OpenGL property or [`SDL_WINDOW_OPENGL`](SDL_WindowFlags) flag set.
