...
| int                                | **numevents** | if action is [SDL_ADDEVENT](SDL_EventAction), the number of events to add back to the event queue; if action is [SDL_PEEKEVENT](SDL_EventAction) or [SDL_GETEVENT](SDL_EventAction), the maximum number of events to retrieve. |
| [SDL_EventAction](SDL_EventAction) | **action**    | action to take; see [Remarks](#remarks) for details.                                                                                                                                                                   |
| [Uint32](Uint32)                   | **minType**   | minimum value of the event type to be considered; [SDL_EVENT_FIRST](SDL_EventType) is a safe choice.                                                                                                                 |
| [Uint32](Uint32)                   | **maxType**   | maximum value of the event type to be considered; [SDL_EVENT_LAST](SDL_EventType) is a safe choice.                                                                                                                   |
...
- [`SDL_ADDEVENT`](SDL_EventAction): up to `numevents` events will be added to
  the back of the event queue.
- [`SDL_PEEKEVENT`](SDL_EventAction): `numevents` events at the front of the
...
- [`SDL_GETEVENT`](SDL_EventAction): up to `numevents` events at the front of
