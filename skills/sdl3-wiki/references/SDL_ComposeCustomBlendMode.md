...
- **direct3d**: Supports all operations with all factors. However, some
  ...
  [`SDL_BLENDOPERATION_MINIMUM`](SDL_BlendOperation) and
  [`SDL_BLENDOPERATION_MAXIMUM`](SDL_BlendOperation).
- **direct3d11**: Same as Direct3D 9.
- **opengl**: Supports the
  [`SDL_BLENDOPERATION_ADD`](SDL_BlendOperation) operation with all
...
target. The [`SDL_BLENDFACTOR_DST_ALPHA`](SDL_BlendFactor) and
