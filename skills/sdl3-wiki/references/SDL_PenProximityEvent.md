...
[SDL_EVENT_PEN_PROXIMITY_IN](SDL_EventType) event with the new
...
leaving the area are handled by [SDL_EVENT_PEN_DOWN](SDL_EventType)
and [SDL_EVENT_PEN_UP](SDL_EventType).
