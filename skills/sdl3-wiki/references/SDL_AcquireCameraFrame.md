...
| [Uint64](Uint64) *         | **timestampNS** | a pointer filled in with the frame's timestamp, or 0 on error. Can be NULL. |
...
[SDL_EVENT_CAMERA_DEVICE_DENIED](SDL_EventType)) event, or
