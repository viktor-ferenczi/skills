...
[SDL_CAMERA_PERMISSION_STATE_DENIED](SDL_CameraPermissionState) if
the user denied access.

Instead of polling with this function, you can wait for a
[SDL_EVENT_CAMERA_DEVICE_APPROVED](SDL_EventType) (or
[SDL_EVENT_CAMERA_DEVICE_DENIED](SDL_EventType)) event in
