...
Returning [SDL_ENUM_CONTINUE](SDL_EnumerationResult) will let enumeration
proceed, calling the callback with further entries.
[SDL_ENUM_SUCCESS](SDL_EnumerationResult) and
[SDL_ENUM_FAILURE](SDL_EnumerationResult) will terminate the enumeration early,
