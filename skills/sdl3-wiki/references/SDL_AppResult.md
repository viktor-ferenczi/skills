...
Returning [SDL_APP_SUCCESS](SDL_AppResult) or
[SDL_APP_FAILURE](SDL_AppResult) from [SDL_AppInit](SDL_AppInit),
...
Returning [SDL_APP_CONTINUE](SDL_AppResult) from these functions will
