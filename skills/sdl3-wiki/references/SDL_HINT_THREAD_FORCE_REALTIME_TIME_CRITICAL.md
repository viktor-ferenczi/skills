...
Specifies whether [SDL_THREAD_PRIORITY_TIME_CRITICAL](SDL_ThreadPriority) should be treated as realtime.
...
- "1": Force
  [SDL_THREAD_PRIORITY_TIME_CRITICAL](SDL_ThreadPriority) to
